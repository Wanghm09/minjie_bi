...
<html lang="">
  <head>
    ...
    <title>天幕权限管理平台</title>
    <script src="/hdlWebQRCode.js"></script>
    <link rel="icon" href="/favicon.ico" />
    <script type="module" crossorigin src="/assets/index.1d167a17.js"></script>
    <link rel="stylesheet" href="/assets/index.35f90f7d.css">
  </head>
  ...
  <body>
    ...
    <div id="app">
      ...
      <div class="app-loading">
        <div class="la-ball-spin-fade la-dark la-3x">
          <div></div>
          <div></div>
          <div></div>
          <div></div>
